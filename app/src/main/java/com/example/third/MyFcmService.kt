...
class MyFcmService : FirebaseMessagingService() {
    ...
    private const val NOTIFICATION_CHANNEL_ID = "TUNDRA_CHANNEL_ID"
    }
    ...
    private fun showChatNotification(title: String, body: String, senderUid: String){
        ...
        val notificationBuilder = NotificationCompat.Builder(this, NOTIFICATION_CHANNEL_ID)
            .setSmallIcon(R.drawable.tundra)
